...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Add Sound Packs to Your CLI",
    description:
      "One block. Paste it into your AI coding agent. 90+ sound packs, zero audio work.",
  },
  twitter: {
...
const AGENT_SKILL = `# Add CESP Sound Pack Support to This CLI

You are adding sound pack support to this CLI using the CESP (Coding Event Sound Pack) open standard. CESP lets any CLI tap into 90+ community sound packs — from Warcraft peons to GLaDOS to StarCraft battlecruisers.

Read this codebase. Find the event system (command lifecycle, hooks, callbacks, event emitters — whatever this CLI uses). Then wire up CESP support following the spec below.
...
If you want your users to choose from 90+ packs, keep reading.
...
- 90+ packs: https://openpeon.com/packs
